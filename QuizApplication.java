...
public class QuizApplication {
    public static void main(String[] args) {
        ...
        quizQuestions.add(new Question("How Old is the Solar System",
                new ArrayList<>(Arrays.asList("5000 years", "5 million years", "500 million years", "5 billion years")),
                3));
        ...
        int userScore = 0;
        QuizTimer quizTimer = new QuizTimer(20); // 20 seconds for each question
